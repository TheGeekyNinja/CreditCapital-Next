    ...
    <footer className="bg-[#003366] text-white">
        ...
        <div className="grid grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">Website use disclaimers</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Cookies policy</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Terms of use for Website</a></li>
            </ul>
          </div>
      ...
      <div>
        <div className="max-w-7xl mx-auto px-5 py-8">
          ...
          <p className="text-[#CCCCCC] text-sm text-left max-w-4xl mx-auto mb-6">
